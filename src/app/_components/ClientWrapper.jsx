...
export const DynamicPlansSection = dynamic(() => import('./PlansSection'), {
  loading: () => <LoadingPlaceholder className="min-h-[400px] bg-gradient-to-b from-white to-blue-50" />,
  ssr: false
});

export const DynamicFeaturesSection = dynamic(() => import('./FeaturesSection'), {
  loading: () => <LoadingPlaceholder className="min-h-[400px] bg-white" />,
  ssr: false
});

export const DynamicLocationsSection = dynamic(() => import('./LocationsSection'), {
  loading: () => <LoadingPlaceholder className="min-h-[400px] bg-gray-50" />,
  ssr: false
});
