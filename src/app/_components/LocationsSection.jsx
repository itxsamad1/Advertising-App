            ...
            <div className="bg-white shadow overflow-hidden rounded-2xl">
              <div className="px-4 py-5 sm:p-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Shahrah-e-Faisal</h3>
                    <div className="space-y-4">
                      <div>
                        <h4 className="text-lg font-medium text-gray-900">Screen Specifications</h4>
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-gray-900">Location Benefits</h4>
                        <ul className="mt-2 text-gray-600 space-y-2">
                          <li className="flex items-center">
                            <svg className="h-5 w-5 text-blue-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
