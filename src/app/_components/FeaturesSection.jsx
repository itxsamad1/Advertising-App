  ...
  const features = [
    {
      ...
      description: 'Our SMD screens are strategically placed in high-traffic areas ensuring maximum visibility for your advertisements.',
      icon: (
    ...
    },
    {
      ...
      description: 'Track your campaign performance with our advanced analytics dashboard. Monitor views, engagement, and ROI in real-time.',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Update your advertisements in real-time. Perfect for time-sensitive promotions, events, or adaptive marketing campaigns.',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Our team of expert designers will help you create eye-catching advertisements that align with your brand identity.',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Choose the perfect time slots for your target audience. Run your ads during peak hours or specific events.',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: 'Multi-screen Campaigns',
      description: 'Synchronize your advertisements across multiple screens to create impactful, city-wide campaigns.',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
