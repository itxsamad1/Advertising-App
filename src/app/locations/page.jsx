    ...
    <div className="pt-24 min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        >
          ...
          <p className="mt-4 text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              <Link href={`/locations/${location.id}`}>
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="p-6">
                      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{location.name}</h2>
                      <p className="text-gray-600 dark:text-gray-300 mb-6">{location.address}</p>
                      ...
                      <p className="mt-6 text-gray-600 dark:text-gray-300">{location.description}</p>
                    </div>
                  </div>
                </div>
              </Link>
